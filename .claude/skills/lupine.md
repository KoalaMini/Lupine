...
请读取以下文件：
- SPECS/{功能名称}-v{版本号}-{YYYYMMDDHHmm}.md（已确认版本）
- CLAUDE.md（项目约定）

输出技术设计方案到 PLANS/YYYYMMDDHHmm-{功能名称}.md，包含：
...
请读取：
- SPECS/{功能名称}-v{版本号}-{YYYYMMDDHHmm}.md
...
输出审查报告到 REVIEWS/{功能名称}-v{版本号}-{YYYYMMDDHHmm}-plan.md，按以下分级：
...
输出审查报告到 REVIEWS/{功能名称}-v{版本号}-{YYYYMMDDHHmm}-code.md，按以下分级：
