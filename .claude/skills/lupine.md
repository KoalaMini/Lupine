...
2. 基于 `VISION.md`，进入功能级需求澄清 → 迭代产出 `SPECS/YYYYMMDD-{功能名称}.md`
...
输出审查报告到 REVIEWS/YYYYMMDD-{功能名称}-plan.md，按以下分级：
...
输出审查报告到 REVIEWS/YYYYMMDD-{功能名称}-code.md，按以下分级：
